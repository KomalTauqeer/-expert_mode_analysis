...
void particle_350_bukinFit()
{
  Double_t bukin(Double_t *x, Double_t *par);
  TFile *file = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles/particle_level_350.root","READ");
  TFile *f1 = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles_fit/particle_level_350.root","RECREATE");
  ...
  TF1* f = new TF1("fit",bukin,100,500,6);  
  f -> SetParameters(1.,301.7,147.6,-0.2,0.01,0.01);
  ...
  c1 -> SaveAs("particle_level_350_fit.pdf");
  hist -> Write();
