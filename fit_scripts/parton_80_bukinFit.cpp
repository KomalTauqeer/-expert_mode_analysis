...
void parton_80_bukinFit()
{
  Double_t bukin(Double_t *x, Double_t *par);
  TFile *file = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles/parton_level_80.root","READ");
  TFile *f1 = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles_fit/parton_level_80.root","RECREATE");
  TCanvas* c1 = new TCanvas("c1");
  TH1F* hist;
  file -> GetObject("hist_80",hist);
  hist -> Sumw2();
  Double_t x = {1.};
  Double_t par[6] = {1.,120.,20.-0.2,0.01,0.01};
  TF1* f = new TF1("fit",bukin,77.5,82.5,6);  
  f -> SetParameters(1.,81.93,22.31,-0.2,0.01,0.01);
  ...
  hist -> SetTitle("");
  hist -> GetXaxis() -> SetRangeUser(70,95);
  ...
  c1 -> SaveAs("parton_level_80_fit.pdf");
  hist -> Write();
