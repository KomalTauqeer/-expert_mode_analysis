...
void particle_80_bukinFit()
{
  Double_t bukin(Double_t *x, Double_t *par);
  TFile *file = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles/particle_level_80.root","READ");
  TFile *f1 = new TFile("/afs/cern.ch/work/k/ktauqeer/private/MadGraph/madanalysis5/rootFiles_fit/particle_level_80.root","RECREATE");
  ...
  TF1* f = new TF1("fit",bukin,0,110,6);  
  f -> SetParameters(1.,108.6,92.57,-0.2,0.01,0.01);
  ...
  c1 -> SaveAs("particle_level_80_fit.pdf");
  hist -> Write();
