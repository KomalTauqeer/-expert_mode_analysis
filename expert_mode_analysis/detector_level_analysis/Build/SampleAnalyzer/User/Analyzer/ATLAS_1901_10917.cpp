...
// -----------------------------------------------------------------------------
bool ATLAS_1901_10917::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
...
// -----------------------------------------------------------------------------
void ATLAS_1901_10917::Finalize(const SampleFormat& summary, const std::vector<SampleFormat>& files)
{
...
// -----------------------------------------------------------------------------
bool ATLAS_1901_10917::Execute(SampleFormat& sample, const EventFormat& event)
{
  // ***************************************************************************
